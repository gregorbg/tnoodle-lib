...
public class PyraminxState extends PuzzleState<PyraminxState> {
    ...
    @Override
    public LinkedHashMap<String, PyraminxState> getSuccessorsByName() {
        LinkedHashMap<String, PyraminxState> successors = new LinkedHashMap<String, PyraminxState>();
    ...
    @Override
    protected PyraminxState unpack() {
        return this;
    }
